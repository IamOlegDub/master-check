...
export default function NotFound() {
    return (
        <main className="grid min-h-dvh place-items-center bg-linear-to-br from-[#f6f4ff] via-white to-[#edf7f6] p-6 text-ink">
            <div className="w-full max-w-lg rounded-3xl border border-white bg-card/80 p-8 text-center shadow-[0_24px_80px_#584a9912] sm:p-12">
                <div className="mx-auto mb-6 grid size-20 place-items-center rounded-3xl bg-[var(--tone-bg-eeebff)] text-brand">
                    <MapPinOff size={36} />
                </div>
                ...
                <div className="mt-8 grid gap-3">
                    <Link
                        href="/"
                        className="flex items-center justify-center gap-2 rounded-xl bg-[var(--brand-solid)] px-5 py-3 text-white"
                    >
                        <Home size={18} />
